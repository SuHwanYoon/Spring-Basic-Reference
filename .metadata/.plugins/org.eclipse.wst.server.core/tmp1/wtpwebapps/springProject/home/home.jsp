...
<header>
	<div align="center">
		<img alt="" src="../imgs/exchange.jpg" height="250px" width="70%" >
	</div>
</header>
<section>
	<table id="body">
		<tr>
			...
			<div id="login">
				...
				<div id="menu">
					...
					<a href="../write/read.html">가입인사목록</a><br/>
						<c:choose>
						<c:when test="${sessionScope.MAN != null }">
					...
					<a href="../write/imageList.html">우리동네소통</a><br/>
					<a href="../write/tradeForm.html">거래 글쓰기</a><br/>
					<a href="../write/tradeList.html">거래 목록</a><br/>
					<a href="">장바구니 보기</a><br/>
				</div>
			</td>
			<td id="content">
